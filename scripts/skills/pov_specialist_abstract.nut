this.pov_specialist_abstract <- this.inherit("scripts/skills/skill", {
	m = {
	...
	// calculates the bonuses based on 3 options - level, week or camp training (old legends system, kept its stuff in case I wanna use it)
	...
	function calculateSpecialistBonus( _stat, _item)
	{
		...
		{
		return this.Math.floor(0.01 * this.Math.min(3 * actor.getLevel() + 20, 50) * _stat);
		}
	...
	*/
	...
	{
		// update my properties faaaaaaaah
	}
